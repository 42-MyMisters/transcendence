...
function RegisterImg() {
	...
	return (
		<form>
			...
			<label className="input-file-btn" htmlFor="input-file" style={{fontSize: 42}}><MdAddPhotoAlternate/></label>
			<input type="file" id="input-file" accept="image/png, image/jpeg" style={{display:"none"}} onChange={handleChange} />
		</form>
	);
}
